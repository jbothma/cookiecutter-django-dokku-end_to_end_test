"""
Django settings for end_to_end_test project.
...
PROJ_DIR = ROOT_DIR.path("end_to_end_test")
...
INSTALLED_APPS = [
    ...
    "end_to_end_test.initial_app.apps.InitialAppConfig",
...
ROOT_URLCONF = "end_to_end_test.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": ["end_to_end_test/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "end_to_end_test.wsgi.application"
